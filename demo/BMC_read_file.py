...
class ReadFile(object):
    ...
    def read_file(self, file, encoding="IS-8859-1", type="DAQ"):
        content = self.read(file, encoding)
        self.clean_format(content, type)

    def read(self, file, encoding="IS-8859-1"):
        """
        :param file:
    ...
    def clean_format(self, DeviceData, type='DAQ'):
        """pass"""
